...
# Global Services data loading (Hoisted)
...
for (HSCP in hscp_list) {
  ...
  # Services data manipulation & Map (Hoisted to HSCP loop)
  ...
  # Clean up objects created in the HSCP loop that are no longer needed
  # after all localities in the partnership have been processed.
  rm(
    list = intersect(
      c(
        "service_map",
