...
#                                                                              #
################################################################################ .
# This script handles locality-specific filtering, plot generation, and text
# object creation for the current locality.

# 1. Locality Filtering & Aggregation ----

# Use global lookup to filter for current locality
lookup_loc <- lookup_dz_all |>
...
# 4. Council Tax Band Locality Data ----

# Filter and aggregate
house_dat2 <- house_raw_dat2 |>
  filter(data_zone_code %in% lookup_loc[["datazone2011"]]) |>
  select(5:14) |>
  summarise(across(everything(), sum))


# 5. Council Tax Band Plots & Tables ----
...
# 6. Locality Specific Objects for Summary Table ----
...
# 7. Comparison with "Other Localities" in Summary Table ----

# Identify other localities in this HSCP
other_locs <- house_dat_all_locs |>
  filter(hscp_locality != LOCALITY) |>
