...
# 4. Council Tax Band Data (Locality) ----
...
# 5. Other localities in HSCP ----

# Derived from pre-calculated HSCP data
other_locs_data <- house_dat_all_locs |>
  dplyr::filter(hscp_locality != LOCALITY) |>
