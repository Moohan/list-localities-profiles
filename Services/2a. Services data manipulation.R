...
# This script is intended to be run at the HSCP level.
...
# Older People (used for map and table)
...
# Cleanup of temporary objects not needed by other scripts
rm(
  care_homes,
  Clacks_Royal,
  data,
