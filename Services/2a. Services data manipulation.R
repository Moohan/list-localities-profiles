...
## Code used to manipulate services data for locality profiles at the partnership level.
# Hoisted out of the locality loop for performance optimization.
...
## Determine HSCP if not already defined (defensive for standalone sourcing)
