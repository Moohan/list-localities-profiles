...
# This script is designed to be sourced once per HSCP in an outer loop.
...
## Determine HSCP if not already defined (e.g. when testing this script in isolation)
...
# Housekeeping ----
# Some objects are kept for use in the locality-level script (2b) or map script (3):
# markers_gp, markers_miu, markers_emergency_dep, markers_care_home,
# care_homes, postcode_lkp, lookup2, n_loc, ext_year.
# They should be cleaned up at the end of the HSCP loop in the main render script.
