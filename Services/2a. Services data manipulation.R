...
## Code used to prepare services data for locality profiles at the HSCP level.
## Refactored for performance by hoisting out of locality loops.
...
# Locality lookup at Datazone level
