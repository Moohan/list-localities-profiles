...
## This script is intended to be run at the HSCP level (once per partnership).
...
services_file_names <- list.files(
  file.path(lp_path, paste0("Services/DATA ", ext_year)),
  pattern = "RDS"
)
...
# NOTE: Housekeeping is deferred to the end of the HSCP loop in the main scripts.
