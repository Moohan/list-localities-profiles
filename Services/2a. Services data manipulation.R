...
# This script operates at the HSCP level and is intended to be sourced in the outer loop
# of the main render scripts (Build Profiles.R and excel_output.R).
...
## Determine HSCP
# Defensive logic to ensure HSCP is defined if sourced in a context where only LOCALITY is known
...
# Housekeeping is handled in the calling script (Build Profiles.R or excel_output.R)
# after the inner locality loop completes, to avoid memory buildup across HSCPs.
