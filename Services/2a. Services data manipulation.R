...
## This script contains HSCP-level logic and should be sourced in the outer loop.
...
## Determine HSCP
# If LOCALITY is defined (e.g. in testing), use it to find HSCP.
# Otherwise, HSCP should already be defined by the outer loop.
