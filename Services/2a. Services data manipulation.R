...
# This script contains HSCP-level logic and should be sourced once per partnership.
...
## Determine HSCP
# Use existing HSCP if available (e.g. from Build Profiles loop),
# otherwise derive it from LOCALITY (for standalone/testing).
