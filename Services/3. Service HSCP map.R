...
# Note: many objects like markers_gp, lookup2, service_map etc.
# are preserved here for use in the locality-level scripts
# and will be cleaned up in the outer loop of Build Profiles.R
