...
# Bolt ⚡: rm() calls removed here as these objects are now needed by
# locality-level scripts (2b. Services table.R) or for environment cleanup
# at the end of the HSCP loop in Build Profiles.R
