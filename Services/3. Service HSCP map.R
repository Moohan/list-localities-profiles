...
# 4 Cleanup ----
# remove unnecessary objects. Note that shared objects like markers_*
# and postcode_lkp are NOT removed here as they are needed for downstream
# locality-level scripts and excel output.
rm(
  all_markers,
  api_key,
  blank_leg,
