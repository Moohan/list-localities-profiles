############################################################################################# .
#                                                                                           #
#                   LOCALITY PROFILES SERVICES MAP & TABLE CODE (HSCP)                      #
#                                                                                           #
############################################################################################# .

## Code used to manipulate services data for locality profiles.
# This script prepares all the HSCP-level data required for the services map and tables.
...
# Housekeeping ----
# The objects removed here are intermediate and no longer needed for downstream processes.
rm(
  file,
  hosp_lookup,
  name,
