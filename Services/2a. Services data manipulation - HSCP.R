############################################################################################# .
#                                                                                           #
#                   LOCALITY PROFILES SERVICES MAP & TABLE CODE - HSCP DATA                 #
#                                                                                           #
############################################################################################# .

## Code used to manipulate services data for locality profiles.
# This script prepares all the data at an HSCP level.
# It is sourced in the outer (HSCP) loop of 'Build Profiles.R' to avoid
# re-running expensive data loading for every locality.
...
# Housekeeping ----
# Objects removed at the end of the HSCP loop in 'Build Profiles.R'
gc()
