...
## Refactored by Bolt - 2024-07-29 - Removed HSCP-level logic to improve performance.

###### 1. Table ######

# The data (`markers_gp`, `markers_emergency_dep`, `markers_miu`, `markers_care_home`,
# and `care_homes`) are now loaded in the HSCP-level script
# `Services/1. Services data manipulation.R`, sourced in the outer loop.

# Subset care which is not Elderly care for table
# Note: This postcode lookup is also now loaded in the HSCP-level script.
