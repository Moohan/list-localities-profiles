# LOCALITY PROFILES SERVICES MAP & TABLE CODE - LOCALITY-LEVEL
...
# HSCP-level data prep is handled in "1. Services HSCP data prep.R"
# The map is created in script "3. Services HSCP Map"

# Determine the HSCP for the current locality
# This is needed to filter some of the HSCP-level data frames
HSCP <- lookup |>
...
# Housekeeping ----
# Objects are removed at the end of the locality loop
rm(
  other_care_type,
  HSCP
)
