...
# Housekeeping ----
# Objects created here are used in downstream scripts (map and table)
# so are not removed until those scripts are finished.
# The original script's cleanup is partially moved here.
rm(
  data,
  file,
  hosp_lookup,
