...
# This script produces a table of what services are in the specific locality.
# It is intended to be sourced once per locality in the inner rendering loop.

# 1. Prepare locality-specific data ----
...
# Clean up locality-specific intermediate objects
rm(other_care_type)
