...
## This script handles locality-level processing.
## It should be sourced in the inner loop (per locality).
...
# Housekeeping ----
# These objects are locality-specific and can be removed after the table is created.
rm(other_care_type)
gc()
