...
## Code used to create the services table for locality profiles at the LOCALITY level.
## This script is sourced once per LOCALITY in the inner loop of Build Profiles.R.

###### 1. Table ######

# Subset care which is not Elderly care for table
# Depends on markers_care_home being prepared at the HSCP level in script 2a.
