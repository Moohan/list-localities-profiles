...
## This script should be sourced once per locality in the inner loop of report generation.
## It depends on objects created by "Services/2a. Services data manipulation.R".
