...
# This script operates at the locality level and is intended to be sourced in the inner loop
# of the main render scripts (Build Profiles.R).

###### 1. Table ######

# Subset care which is not Elderly care for table
# This requires 'care_homes' and 'postcode_lkp' from the manipulation script
