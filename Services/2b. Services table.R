...
# This script contains locality-level logic.
# It is sourced once per locality in the inner loop of Build Profiles.R.
...
# Housekeeping for locality-specific objects
rm(other_care_type)
