# LOCALITY PROFILES SERVICES MAP & TABLE CODE - HSCP DATA PREP
...
# Note: 'lookup' is created in the main 'Build Profiles.R' script
# 'HSCP' is the current HSCP in the loop in 'Build Profiles.R'
...
# Housekeeping
# Objects to be removed at the end of the HSCP loop
hscp_level_housekeeping <- c(
  "hosp_lookup",
  "prac",
  "services_file_names",
  "file",
