...
for (HSCP in hscp_list) {
  ...
  # Moved from the inner 'locality' loop to the outer 'HSCP' loop
  # This map is the same for every locality in an HSCP, so it's
  # inefficient to re-generate it for every locality.
