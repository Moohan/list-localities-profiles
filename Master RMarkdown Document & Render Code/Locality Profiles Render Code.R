...
for (HSCP in hscp_list) {
  ...
  # Services ----
  source("Services/2a. Services data manipulation.R", local = TRUE)
  source("Services/3. Service HSCP map.R", local = TRUE)
  ...
  # Tidy up HSCP-level objects at the end of each HSCP iteration
  rm(
    care_homes,
    hosp_postcodes,
    hosp_types,
