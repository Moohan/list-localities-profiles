...
loc_values <- format_number_for_text(c(avg_life_exp_latest_male, avg_life_exp_latest_fem, deaths_15_44_latest, ltc_percent_total_latest, cancer_reg_rate_latest, adp_presc_latest))
...
# Values
loc_values <- format_number_for_text(c(alcohol_hosp_latest, alcohol_deaths_latest, drug_hosp_latest, bowel_screening_latest))
...
# Values
loc_values <- format_number_for_text(c(latest_emergency_adm_loc2, latest_bed_days_loc2, latest_ae_att_loc2, latest_dd_loc2, latest_ppa_loc$data[2]))
other_loc_values <- bind_rows(other_loc_emergency_adm, other_loc_bed_days, other_loc_ae_att, other_loc_dd, other_loc_ppa)
hscp_values <- format_number_for_text(c(hscp_emergency_adm$data, hscp_bed_days$data, hscp_ae_att$data, hscp_dd$data, filter(hscp_ppa, year == max(year))$data))
scot_values <- format_number_for_text(c(scot_emergency_adm$data, scot_bed_days$data, scot_ae_att$data, scot_dd$data, filter(scot_ppa, year == max(year))$data))
...
# Values
loc_values <- c(
  format_number_for_text(psych_hosp_latest),
  format_number_for_text(ifelse(is_empty(latest_bed_days_mh_loc2), NA_real_, latest_bed_days_mh_loc2))
)

other_loc_values <- bind_rows(other_locs_psych_hosp, other_loc_bed_days_mh)
hscp_values <- c(
  format_number_for_text(filter(hscp_psych_hosp, year == max(year))$measure),
  format_number_for_text(hscp_bed_days_mh$data)
)
scot_values <- c(
  format_number_for_text(filter(scot_psych_hosp, year == max(year))$measure),
  format_number_for_text(scot_bed_days_mh$data)
)
